<div class="row">
        ...
        <div class="d-flex flex-row">
            <div class="avatar me-2">
                <div class="avatar-content">
                    <img src="{{ asset('admin/app-assets/images/like.png') }}" class="img-responsive" alt=""
                        onclick="getOverall('positive')" data-bs-toggle="modal" data-bs-target="#overallModal">
        ...
        <div class="d-flex flex-row">
            <div class="avatar me-2">
                <div class="avatar-content">
                    ...
                    <img src="{{ asset('admin/app-assets/images/dislike.png') }}" class="img-responsive" alt=""
                        onclick="getOverall('negative')" data-bs-toggle="modal" data-bs-target="#overallModal">
        ...
        <div class="d-flex flex-row">
            <div class="avatar me-2">
                <div class="avatar-content">
                    ...
                    <img src="{{ asset('admin/app-assets/images/mixed.png') }}" class="img-responsive" alt=""
                        onclick="getOverall('mixed')" data-bs-toggle="modal" data-bs-target="#overallModal">
                </div>
            </div>
            <div class="my-auto">
    ...
    <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
        <div class="d-flex flex-row">
            <div class="avatar neutral-avatar me-2">
                <div class="avatar-content">

                    <img src="{{ asset('admin/app-assets/images/neutral.png') }}" class="img-responsive" alt=""
                        onclick="getOverall('neutral')" data-bs-toggle="modal" data-bs-target="#overallModal">
                </div>
            </div>
            <div class="my-auto">
